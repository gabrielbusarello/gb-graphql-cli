...
function createFile(projName) {
    ...
    "scripts": {
        ...
        "dev": "set NODE_ENV=development & set JWT_SECRET=batman & nodemon --delay 5 dist/index",
...
export class DataLoaderFactory {
    ...
    public getLoaders(): DataLoaders {
        return {
            /* Here you create yours loaders; Examples: 
...
export class ExampleLoader {
    static batchExample(Example: ExampleModel, params: DataLoaderParam<number>[], requestedFields: RequestedFields): Promise<ExampleInstance[]> {
...
createFile.prototype.baseModelInterface = () => {
    const baseModelInterface = `import { ModelsInterface } from './ModelsInterface';
...
export default (sequelize: Sequelize.Sequelize, DataTypes: Sequelize.DataTypes): ExampleModel => {
    ...
    Example.associate = (models: ModelsInterface): void  => {};
